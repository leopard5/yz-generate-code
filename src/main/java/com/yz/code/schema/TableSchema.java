...
public class TableSchema {
    ...
    public boolean hasDateColumn() {
        for (ColumnSchema columnSchema : columns) {
            if (columnSchema.getDataType() == DataTypeEnum.DATE.getDataType()
                    || columnSchema.getDataType() == DataTypeEnum.TIMESTAMP.getDataType()) {
                return true;
            }
        }
        return false;
    ...
    public boolean hasBigDecimalColumn() {
        for (ColumnSchema columnSchema : columns) {
            if (columnSchema.getDataType() == DataTypeEnum.DECIMAL.getDataType()) {
                return true;
            }
        }
        return false;
